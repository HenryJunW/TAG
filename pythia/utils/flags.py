...
class Flags:
    ...
    def add_core_args(self):
        ...
        self.parser.add_argument(
            "--save_aug_imdb_path", type=str, default=None, help="Location for saving augmentated imdb file name"
        )
        self.parser.add_argument(
            "--vocab_file ", type=str, default='./data/m4c_vocabs/textvqa/fixed_answer_vocab_textvqa_5k.txt', help="Location for the vocab file",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            nargs='+',
            default=None,
            help="Use when you want to use lr decay lr_steps",
        )
        self.parser.add_argument(
            "--clip_gradients",
            type=bool,
        ...
        self.parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="if go switch mode (MLM and Seq pretraining task)",
        )
        self.parser.add_argument(
            "--use_qag",
            action="store_true",
            default=False,
            help="if go switch mode (vqa and vqg mode",
        )
        self.parser.add_argument(
            "--generate_aug_training",
            action="store_true",
            default=False,
            help="generate augmented dataset from training using trained vqg model",
        )
        self.parser.add_argument('--gpu', default='0,1,2,3,4,5,6,7', help='gpu id')
        self.parser.add_argument('--MASTER_PORT', default='29500',
            help='master port for distributed training. torch.distributed.init_process_group')
